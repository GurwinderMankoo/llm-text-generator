...
export default function SiteInfoStep() {
  ...
  const { siteName, siteDesc, siteNotes, siteCategory, siteNameError, siteInfoInput } = state;
    ...
    <div className="animate-[fadeIn_0.3s_ease]">
      ...
      <div className="bg-surface border border-border-custom rounded-2xl p-6 mb-4">
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className={`w-full bg-surface2 border rounded-lg px-3.5 py-2.5 font-mono text-[13px] text-text-custom outline-none transition-all duration-200 ${siteNameError
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            value={siteInfoInput}
            onChange={(e) => onChange(e)}
            className="absolute left-0 w-full siteInfoInput"
          />
        </div>
      </div>
      ...
      <div className="bg-surface border border-border-custom rounded-2xl p-6 mb-4">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label htmlFor="siteCategory" className="block text-[12px] font-mono text-muted-custom tracking-wider">
              SITE CATEGORY
            </label>
            <select
              value={siteCategory}
